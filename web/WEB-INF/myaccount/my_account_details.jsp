                        ...
                        <div class="entry-content">
                            <div class="woocommerce">
                                ...
                                <div class="woocommerce-MyAccount-content">
                                    <form class="edit-account" action="${pageContext.request.contextPath}/UpdataUserInfomation" method="post" id="form1">
                                        ...
                                        <fieldset>
                                            <legend>更改密码</legend>
                                            <p class="form-row form-row-wide">
                                                <label for="password_current">当前密码（保留空白不变）</label>
                                                <input type="password" class="input-text" name="password_current" id="password_current"/>
                                            </p>

                                            <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
                                                <label for="password_1">新密码（留空不变）</label>
                                                <input type="password" class="input-text" name="password_1" id="password_1"/>
                                            </p>

                                            <p class="form-row form-row-wide">
                                                <label for="password_2">确认新密码</label>
                                        ...
                                        <div class="clear"></div>
                                        <p>
                                            <input type="button" class="button" name="save_account_details" value="保存更改" id="subBtn"/>
                                        </p>
                                    </form>
                                </div>
...
<script>
    $(function () {
        ...
        $("#subBtn").click(function () {
            var $account_first_name_val = $("#account_first_name").val();
            var $account_email_val = $("#account_email").val();

            if ($account_first_name_val == null) {
                alertInfo("姓名不能为空");
            } else if ($account_email_val == null) {
                alertInfo("邮箱地址不能为空");
            }


            var $password_current_val = $("#password_current").val();
            var $password_1_val = $("#password_1").val();
            var $password_2_val = $("#password_2").val();

            if ($password_current_val != null) {
                if ($password_current_val !=${user.userPass}) {
                    alertInfo("当前密码不正确");
                } else {
                    if ($password_1_val == "") {
                        alertInfo("请输入新密码");
